...
file_name = 'project_datasets3/A09T_slice.mat'
X_train, train_targets, X_val, val_targets, X_test, test_targets = preprocess(file_name, 7)
...
optimizer = optim.Adam(model.parameters(), lr=learning_rate, weight_decay=2e-1)
