...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    scores, cache_out = affine_forward(h1, W2, b2)    
    ...
    dout2, grads['W2'], grads['b2'] = affine_backward(dx2, cache_out)
    grads['W2'] = grads['W2'] + self.reg * W2
    dout1, grads['W1'], grads['b1'] = affine_relu_backward(dout2, cache_h1)
...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    for i in range(self.num_layers):
      if (i == 0):
        htemp, cache['h1'] = affine_relu_forward(X, self.params['W1'], self.params['b1'])
